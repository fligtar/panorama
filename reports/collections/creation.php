...
class CollectionCreation extends Report {
    public $table = 'collections_creation';
    ...
    public function analyzeDay($date = '') {
        ...
        $qry = "SELECT collection_type, COUNT(*) FROM collections WHERE DATE(created) = '%DATE%' GROUP BY collection_type ORDER BY collection_type";
