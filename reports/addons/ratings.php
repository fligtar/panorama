...
class AddonRatings extends Report {
    public $table = 'addons_ratings';
    ...
    public function analyzeDay($date = '') {
        ...
        $qry = "SELECT rating, COUNT(*) FROM reviews WHERE DATE(reviews.created) = '%DATE%' AND rating >= 1 GROUP BY rating ORDER BY rating";
    ...
    public function generateCSV() {
        echo "Date,All Ratings,1 star,2 stars,3 stars,4 stars,5 stars\n";

        $dates = $this->db->query_stats("SELECT date, total, star1, star2, star3, star4, star5 FROM {$this->table} ORDER BY date");
