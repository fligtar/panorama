...
class AddonReviews extends Report {
    public $table = 'addons_reviews';
    ...
    public function analyzeDay($date = '') {
        ...
        $qry = "SELECT addontype_id, COUNT(*) FROM addons INNER JOIN reviews ON reviews.addon_id = addons.id WHERE DATE(reviews.created) = '%DATE%' GROUP BY addontype_id ORDER BY addontype_id";
